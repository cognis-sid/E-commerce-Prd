...
/*
-------------------------------------------------------------------------------------------------------------
EserviceBookingNumberPopup.js
-------------------------------------------------------------------------------------------------------------
Copyright RCL Public Co., Ltd. 2007
-------------------------------------------------------------------------------------------------------------  
Author Yossawat Suntisukkasem 16/01/2014
- Change Log ------------------------------------------------------------------------------------------------
...
function callbackToField(bookingNo, bookingType){
	debugger;
    var messageTdParent     = parentDoc.getElementById("msg");
    var params              = "?bookingNo="+bookingNo;
    var lo_pageFlag         = document.getElementById("pageFlag");
    
    //Return to EservicePreviewUploadedDocScn.jsp
    if(lo_pageFlag.value=="P"){
        parentObj.getWebBookingData(bookingNo);
        this.close();
    }else{
        try{
