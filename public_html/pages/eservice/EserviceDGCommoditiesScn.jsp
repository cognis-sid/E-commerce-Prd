...
<%@ page import="com.rclgroup.dolphin.rcl.web.eservice.actionform.EserviceDGCommoditiesUim" %>
...
<script type="text/javascript" src="<%=contextPath%>/js/screen/EserviceDGCommodities.js" ></script>
<script type="text/javascript">
    var SUBMIT          = '<%=com.niit.control.web.JSPUtils.getActionMappingURL("/serv020onSubmit", pageContext)%>';
    var UNNO_LOOKUP     = '<%=com.niit.control.web.JSPUtils.getActionMappingURL("/serv022", pageContext)%>';
    var VALIDIDATE_DG   = '<%=com.niit.control.web.JSPUtils.getActionMappingURL("/serv020validateDG", pageContext)%>';
</script>
</head>
<body onload="onLoad();">
<html:form method="post" styleId="frm" action="/serv020">
    <html:hidden name="feserv20" property="errMsg" />
    <html:hidden name="feserv20" property="seqNo" styleId="seqNo" />
    <html:hidden name="feserv20" property="rowIndex" styleId="rowIndex" />
    <html:hidden name="feserv20" property="disBtn" styleId="disBtn" />
...
<%-- ########################## PERSONAL Detail === START  ############################# --%>                    
                    <table width="95%" border="0" cellspacing="2" cellpadding="0" align="center" class="table_sub_detail">
                        <tr class="tr_sub_detail">
                            ...
                            <td width="80%">
                                <html:text name="feserv20" property="flashPoint" styleId="flashPoint" onkeypress="return gp_validNumberKeyMinus(event);" onblur="lp_onBlursetFormat();" style="width: 100px;" />&nbsp;
                                <html:select name="feserv20" property="unitMeasurement" styleId="unitMeasurement" size="1" onchange="">
                                    <html:optionsCollection name="feserv20" property="unitMeasurementComboList" value="code" label="name" />
                                </html:select>
                            </td>
                        </tr>
                        <tr class="tr_sub_detail">
                            <td>UNNO</td>
                            <td>
                                <html:text name="feserv20" property="unNoDis" styleId="unNoDis" maxlength="5" style="width: 100px;" disabled="true" />&nbsp;
                                ...
                                <html:hidden name="feserv20" property="unNo" styleId="unNo" />
                            </td>
                        </tr>
                        <tr class="tr_sub_detail">
                            <td>Varaint</td>
                            <td>
                                <html:text name="feserv20" property="variantDis" styleId="variantDis" maxlength="1" style="width: 100px;" disabled="true" />
                                <html:hidden name="feserv20" property="variant" styleId="variant" />
                            </td>
                        </tr>
                        <tr class="tr_sub_detail">
                            <td>IMDG Class</td>
                            <td>
                                <html:text name="feserv20" property="imdgClassDis" styleId="imdgClassDis" maxlength="4" style="width: 100px;" disabled="true" />
                                <html:hidden name="feserv20" property="imdgClass" styleId="imdgClass" />
                            </td>
                        </tr>
                        <tr class="tr_sub_detail">
                            <td>Port Class</td>
                            <td>
                                <html:text name="feserv20" property="portClass" styleId="portClass" maxlength="5" style="width: 100px;" />
                            </td>
                        </tr>
                        <tr class="tr_sub_detail">
                            <td>Residue</td>
                            <td align="left">
                                <html:checkbox name="feserv20" property="residue" styleId="residue" value="Y" style="border:0px;width:2%" onclick="" />
                            </td>
                        </tr>
                        <tr class="tr_sub_detail">
                            <td>Fumigation</td>
                            <td align="left">
                                <html:checkbox name="feserv20" property="fumigration" styleId="fumigration" value="Y" style="border:0px;width:2%" onclick="" />
                            </td>
                        </tr>
                    </table>  
                </td>
