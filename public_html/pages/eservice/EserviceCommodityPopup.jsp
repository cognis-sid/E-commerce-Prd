...
<head>
    ...
    <script language="JavaScript">
        var GET_LOOKUP_DATA 
            = '<%=com.niit.control.web.JSPUtils.getActionMappingURL("/serv004LookupData", pageContext)%>';
        var NEW_WEB_BOOKING 
    ...
    <html:form method="POST" action="/serv002">         
        ...
        <table class="table_search" border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td width="25%">
                    <html:select name="feserv04" property="column" size="1">
            ...
            <tr>
                <td>Sort by</td>
                <td>
                    <html:select name="feserv04" property="sortBy" size="1">
                ...
                <td>
                    ...
                    <html:select name="feserv04" property="order" size="1">
        ...
        <table border="0" width="100%" cellspacing="0" class="TablePopup" >
            ...
            %>
                <logic:iterate name="listLookupData" id="listLookupDataId">
                    <tr id="row<%=x%>" 
                        ondblclick="callbackToField('<bean:write name="listLookupDataId" property="code"/>',
