                ...
                <div class="col-12">
                  <div class="card card00 m-2 border-0">
                    <div class="d-flex flex-md-row px-3 mt-4 mb-4 flex-column-reverse">
                      ...
                      <div class="col-md-10 mb-4" style="min-height: 700px;">
                        ...
                        <div class="card2 first-screen show ml-2" id="first-screen" >
                          ...
                          <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                              ...
                              <select name="socCocUserFlag" id="socCocUserFlag" size="1"  class="form-control" onchange="onPolPodStatus();">
								   <c:if test="${feserv01.socCocUserFlag == 'S'}">										
								   ...
								   <c:if test="${feserv01.socCocUserFlag == 'C'}">
                          ...
                          <div class="form-row">
                            <div class="form-group  col-md-6">
                             ...
                             <input type="text" class="form-control" name="customerReference" id="customerReference" value="${feserv01.customerReference}" maxlength='17' onblur="changeUpper(this)" onchange="checkSpecialCharacter(this,'Customer Reference')" />
                            </div>
                            <div class="form-group  col-md-6">
                          ...
                          <div class="form-row">
                            <div class="form-group  col-md-6">
                              ...
                              <input type="text" class="form-control" name="telephone" id="telephone"  onchange="checkNumeric(this,'Phone No')"  value="${feserv01.telephone}" readonly="readonly"/>
                            </div>
                            <div class="form-group  col-md-6">
                          ...
                          <div class="form-group">
                            <label for="inputContactPerson"><bean:message key="web_booking.Contact_Person" /></label><i class="fa fa-asterisk" aria-hidden="true" style="color:red;"></i> 
                             <input type="hidden" class="form-control" required="required" id="orgCode" name="orgCode" maxlength='25'   
                              value="${feserv01.orgCode}" />
                             <input type="text" class="form-control" id="contact" name="contact" maxlength='25' required="required" onblur="changeUpper(this)" onchange="checkSpecialCharacter(this,'Contact Person')" 
                          ...
                          <div class="float-right">
                          	<div class="btn btn-secondary mr-2" onclick="bakeToInqueryPage();">
                        ...
                        <div class="card2 second-screen ml-2" id="second-screen">
                          ...
                          <div class="form-row">
                            <div class="form-group col-md-6">
                              <label for="inputPlaceOfReciept"><bean:message key="web_booking.Place_of_Receipt" /> </label><i class="fa fa-asterisk" aria-hidden="true" style="color:red;"></i>
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <select name="placeOfDelivery" id="placeOfDelivery" size="1" class="form-control"  class="form-control" required="required">
                          ...
                          <div class="form-group" >
	                           <div id="mandatorySymbolDepo" style="diplay:none;">
	                           		<label for="inputEmptyPickUpDepo"><bean:message key="web_booking.Empty_Pickup_Depot" /></label><i class="fa fa-asterisk" aria-hidden="true"  style="color:red;"></i>
	                           </div>
	                           <div id="mandatoryWithOutSymbolDepo" style="diplay:none;">
	                            	<label for="inputEmptyPickUpDepo"><bean:message key="web_booking.Empty_Pickup_Depot" /></label> 
	                           </div>
                            <select name="emptyPickupDepot" id="emptyPickupDepot" size="1" class="form-control"  class="form-control" required="required">
                          ...
                          <div class="form-row">
                            <div class="form-group col-md-3">
                             	 <div id="mandatorySymbolDate" style="diplay:none;">
	                              <label for="etd"><bean:message key="web_booking.Empty_Pickup_Date" /></label><i class="fa fa-asterisk" aria-hidden="true"  style="color:red;"></i>
	                             </div>
	                             <div id="mandatoryWithOutSymbolDate" style="diplay:none;">
	                              <label for="etd"><bean:message key="web_booking.Empty_Pickup_Date" /></label>
	                             </div> 
	                             <div class="input-icons">
	                                <i class="fas fa-calendar-alt icon"></i>
	                                <input type="text" class="form-control  input-field date-picker" value="${feserv01.emptyPickupDate}" id="emptyPickupDate" name="emptyPickupDate" required="required">
	                             </div>
                            </div>
                            <div class="form-group col-md-3">
                              <label for="etd"><bean:message key="web_booking.Cargo_Availability_Date" /> </label><i class="fa fa-asterisk" aria-hidden="true" style="color:red;"></i>
                              <div class="input-icons">
                                <i class="fas fa-calendar-alt icon"></i>
                          ...
                          <div class="form-group">
                            ...
                            <textarea name="routingPreference" class="form-control" id="routingPreference" 
                              rows="4" onkeyup="maxlenghtTextAreaBooking(this, 500)" onclick="maxlenghtTextAreaBooking(this, 500)" >${feserv01.routingPreference}</textarea>
                          </div>
                          <hr>
                              ...
                              <table class="table equipment-comodity-details  border-bottom" id="search_result" style="table-layout: fixed;">
                                ...
                                <thead>
                                  <tr class="bg-light-blue">
                                    <th scope="col-1">#</th>
                                    <th scope="col-2"><bean:message key="web_booking.Type" /><i class="fa fa-asterisk" aria-hidden="true" style="color:red;"></i></th>
                                    ...
                                    <th scope="col-1"><bean:message key="web_booking.Laden" /><i class="fa fa-asterisk" aria-hidden="true" style="color:red;"></i></th>
                                    <th scope="col-1"><bean:message key="web_booking.Empty" /></th>
                                    <th scope="col-2"><bean:message key="web_booking.CargoContainer"/><i class="fa fa-asterisk" aria-hidden="true" style="color:red;"></i></th>
                                  ...
                                  <tr scope="row border-bottom">
                                    ...
                                    <td>
                                      <input type="text" class="form-control form-control-sm" value="${listofequipment.mt }"
                                       name='mt' id="mt${loopCounter.count-1}" disabled maxlength='4' disabled onblur="maskWithOutDecimal(this, 4, 2);updateSizeTypeRecStatusNew(this,${loopCounter.count-1});" >
                                    </td>
                                    <td>
                          ...
                          <div class="row mt-3">
                            <div class="col-12">
                              <textarea class="form-control" 
		                        ...
		                        onkeyup="maxlenghtTextAreaBooking(this, 500)"
		                        onclick="maxlenghtTextAreaBooking(this, 500)">${feserv01.cargoDescription}</textarea>
                            </div>
                          </div>
                              ...
                              <table class="table equipment-comodity-details  border-bottom" id="comm_search_result" style="table-layout: fixed;">
                                ...
                                <thead>
                                  <tr class="bg-light-blue">
                                  	<th scope="col-1"> <th>
                                  	<th scope="col-1">#</th>
                                    <th scope="col-2"><bean:message key="web_booking.Commodity_Group" /><i class="fa fa-asterisk" aria-hidden="true" style="color:red;"></i></th>
                                    <th scope="col-1"></th>
                              ...
                              <table class="table equipment-comodity-details  border-bottom" id="tableSI">
                                ...
                                <c:forEach var="listcommodityVoData" items="${feserv01.commodityVoDataList}" varStatus="loopCounter">
	                                <textarea class="form-control" placeholder='<bean:message key="web_booking.Special_Instructions"/>'
                                	  ...
                                	  onblur="updateCommodityRecStatusNewFortextArea(this);" onkeyup="maxlenghtTextAreaBooking(this, 400)" onclick="maxlenghtTextAreaBooking(this, 400)">${listcommodityVoData.specialInstruction}</textarea>
                           	    </c:forEach>
                           	    			  </td>
                           	    </tr>
                           	  </table>	
                          ...
                          <div class="row">
                            <div class="col-12">
                              <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <button type="button" class="btn btn-success" href="" onClick="return saveBooking(MODE_SAVE_BOOKING);">
                                  &nbsp;&nbsp;
    ...
    <script>
      $(document).ready(function () {   
       ...
       minDate : minDate,
        ...
        $('#emptyPickupDate').datetimepicker({
            format: 'DD-MM-YYYY',
            defaultDate : "",
            minDate : minDate,
             });
     ...
     function bookingDtl(){
   	  ...
   	  var isValid=true;
   	  if($("#contact").val()== ""){   
   		  if(!checkSpecialCharacter($("#contact"),type)){
   			isValid =false; 
   		  }
   		...
   		if (!checkSpecialCharacter($("#contact")[0],'Contact Person')) {
   		  //$("#contact").parsley().validate(true);  
  		  $("#"+ $("#contact").attr("aria-describedby")+" li").html("Contact Person has special characters. \nThese are not allowed.");
   			isValid= false;
        }				
   	  }
   	  if($("#additionalMailRecipeints").val()!= ""){  
   		if(!validateMultipleEmails($("#additionalMailRecipeints")[0])){
   			index--;
   			isValid= false;
   		}
   	  }
    	  ...
    	  if(cocSocVal=='C'){
    		  var index=4;
          	  ...
          	  if($("#placeOfReceipt").val()== ""){   
          		...
          		if($("#emptyPickupDepot").val()== ""){   
          	  	debugger;
        		  $("#emptyPickupDepot").parsley().validate(true);  
        		  $("#"+ $("#emptyPickupDepot").attr("aria-describedby")+" li").html('Please specify Empty Pickup Depot.');
        		  isValid =false;
        		  index--;
          		}
