...
<html>
  <head>
    ...
    <script language="JavaScript">
      ...
      var ON_LOGIN
		= '<%=com.niit.control.web.JSPUtils.getActionMappingURL("/serv00111loingInUser", pageContext)%>';
    </script>
<style>
::placeholder {
  color: #afafaf;
...
<body>
  <div class="login-body">
    <form action="/serv00111" mathod="POST">
     <input type="hidden" name="loginStatus" id="loginStatus"  value="${userUim.loginStatus }"/>
     <input type="hidden" name="errorMessage" id="errorMessage"  value="${userUim.errorMessage }"/>
      <!-- Start Of Nav Bar -->
      ...
      <!-- Start Of Vertical Menu -->
                            ...
                            <div id="panel_bhumnet" class="login-wrapper">
                                ...
                                <div class="login-header">
                                    <div class="login-header-text"><bean:message key="logIn.welcome"/></div>
                                </div>
                                <div class="login-form">
                                    <div class="login-row">
                                        <div class="login-text"><bean:message key="logIn.User_ID"/></div>
                                        <input name="userId" maxlength="30" placeholder="<bean:message key="logIn.Error_Please_provide_User_ID"/>"  id="userId" class="login-field" type="text" required="required" onblur="changeUpper(this)" />
                                    </div>
                                    <div class="login-row">
                                    ...
                                    <div class="login-other-row">
                                        ...
                                        <a class="login-forget login-mini-text" href="<%=lstrCtxPath%>/do/serv009"><bean:message key="logIn.forgotPassword"/></a>
                                    </div>
                                </div>
                              ...
                              <div class="login-text-link css300"><a href="<%=lstrCtxPath%>/do/sexn007"><span class="login-mini-text"><bean:message key="logIn.dontHaveAnAccount"/></span> <bean:message key="logIn.createNewAccount"/></a></div>
                              
                         </div>
                         <div class="login-text-link css300"><a  target="_blank" href="https://youtu.be/5YuNIJRQ92g">e-Service Registration Help <i class="fa fa-question-circle" aria-hidden="true"></i></a></div>
                       </div>
    ...
    var serverUrl = '<%=protocal+"://" + strServerName + ":" + strServerPort%>'; 
      ...
      function openScreen() {
      	...
      	document.forms[0].action = ON_LOGIN+"?userId"+userId+"&password"+txtPwd;
      	document.forms[0].submit();
      }
      ...
      $(document).ready(function () {
    	  ...
    	  if(validateLogin=="true"){
    	      ...
    	      document.forms[0].submit(); */
    		  window.location.href = "./do/sexn002";
    	  }
    	   if($("#errorMessage").val()!=null &&  $("#errorMessage").val()!=""){
    		   ...
    		   }else if( $("#errorMessage").val()=="THIS_ACCOUNT_SUSPENDED"){
    			   swal('<bean:message key="logIn.Error"/>', 'User ID Suspended. Please Re-Aplly', "error");
    		   }else{
