 ...
 name="userInfoMod.address4" id="inputAddress4"
                          ...
                          <div class="form-row ">
                            <div class="form-group col-md-6 ">
                              ...
                              <input type="text" class="form-control" placeholder='<bean:message key="registration.Enter_city_name"/>' required="required" name="userInfoMod.city" id="inputCity"  />
                            </div>
                            <div class="form-group col-md-3 ">
                              <label for="inputState ">
                                <bean:message key="registration.State"/>
                              </label>
                              <input type="text" class="form-control"   placeholder='<bean:message key="registration.Enter_state_name"/>'  name="userInfoMod.state" id="inputState"  maxlength="2" />
                            </div>
                            <div class="form-group col-md-3 ">
                            ...
                            <div class="form-row col-md-6 ">
                              <div class="form-group col-md-6 ">
                                ...
                                <input type="number" class="form-control "   placeholder='<bean:message key="registration.Enter_phone_number"/>' name="userInfoMod.phoneNo" id="phoneNo"   required="required"/>
                              </div>
                              <div class="form-group col-md-6 ">
                                <label for="inputCity ">
                                  <bean:message key="registration.FAX_Number"/>
                                </label>
                                <input type="number" class="form-control" placeholder='<bean:message key="registration.Enter_fax_number"/>' name="userInfoMod.faxNo" id="inputCity"  />
                              </div>
                            </div>
