...
public class UserMod extends PaginationForm {
	...
	public String getWebBooking() {
		return webBooking;
	}

	public void setWebBooking(String webBooking) {
	...
	public String toString() {
		return "UserMod [userId=" + userId + ", password=" + password + ", status=" + status + ", currPageAction="
				+ currPageAction + ", email=" + email + ", loginStatus=" + loginStatus + ", dbPasword=" + dbPasword
				+ ", errorMessage=" + errorMessage + ", firstName=" + firstName + ", lastName=" + lastName
