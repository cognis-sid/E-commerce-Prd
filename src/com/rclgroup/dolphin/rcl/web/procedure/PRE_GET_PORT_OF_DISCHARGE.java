...
public class PRE_GET_PORT_OF_DISCHARGE extends AncestorJdbcDao{

	JdbcTemplate jdbcTemplate;
	Map map;
	String query1;
	public PRE_GET_PORT_OF_DISCHARGE(JdbcTemplate jdbcTemplate,Map map) {
	...
	public void executeDbProcedure() {
		...
		if ("Y".equalsIgnoreCase((String) map.get("P_I_V_REP_FLAG"))
			...
			query1 = "SELECT  " + "              I40.PICODE AS \"CODE\",  " + "              I40.PINAME AS \"DESC\"  "
					...
					+ map.get("P_I_V_COUNTRY_CODE") + "'" + "        and I40.PICODE = '"+map.get("P_I_V_PORT_OF_DISCHARGE")+"'      AND I63.VVPCAL   = I40.PICODE  "
			...
			query1="select code as \"code\" ,name as \"DESC\" from VRL_PORT where code='"+map.get("P_I_V_PORT_OF_DISCHARGE")+"' ";
		}
