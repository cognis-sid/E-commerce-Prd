...
public class FormatUtil {
   ...
   public static Date stringToDate(String target, String format){
      Date result = null;
      try{
    ...
    public static String statusRecDesc(String status){
        ...
        try{
            System.out.println("[FormatUtil][statusRecDesc] status :: " + status);
...
//                statusDesc = status.equals("A") ? "Active":"Expired";
    ...
    public static String getDecimalFormat(Object value, String pattern){
        ...
        if(value.equals("")){
            ...
            return df.format(Float.valueOf((String)value).floatValue());
        }
    }
}
